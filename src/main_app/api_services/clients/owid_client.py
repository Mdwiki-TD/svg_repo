...
def fetch_grapher_metadata_raw(slug: str) -> RawGrapherMetadataResponse:
    """Fetch the OWID chart metadata JSON. Returns a dataclass with raw dict and status code."""
